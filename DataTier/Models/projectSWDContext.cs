...
{
    public partial class projectSWDContext : DbContext
    {
        public projectSWDContext()
        {
        }

        public projectSWDContext(DbContextOptions<projectSWDContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=(local);Database=projectSWD;User Id=sa;Password=123;");
            }
        }
